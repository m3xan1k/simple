...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    ...
    hi Special ctermbg=NONE ctermfg=0 cterm=NONE guibg=NONE guifg=#000000 gui=NONE
    ...
    hi ColorColumn  ctermbg=255 ctermfg=NONE cterm=NONE guibg=#efefef guifg=NONE gui=NONE
