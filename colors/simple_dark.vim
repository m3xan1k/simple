...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    ...
    hi VertSplit ctermbg=236 ctermfg=250 cterm=NONE guibg=#2e3436 guifg=#bcbcbc gui=NONE
    ...
    hi helpLeadBlank ctermbg=236 ctermfg=250 cterm=NONE guibg=#2e3436 guifg=#bcbcbc gui=NONE
    hi helpNormal ctermbg=236 ctermfg=250 cterm=NONE guibg=#2e3436 guifg=#bcbcbc gui=NONE
