...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    hi Normal ctermbg=235 ctermfg=252 cterm=NONE guibg=#080808 guifg=#d0d0d0 gui=NONE
    hi NonText ctermbg=235 ctermfg=252 cterm=NONE guibg=#080808 guifg=#d0d0d0 gui=NONE
    ...
    hi VertSplit ctermbg=235 ctermfg=250 cterm=NONE guibg=#080808 guifg=#bcbcbc gui=NONE
    ...
    hi helpLeadBlank ctermbg=235 ctermfg=250 cterm=NONE guibg=#080808 guifg=#bcbcbc gui=NONE
    hi helpNormal ctermbg=235 ctermfg=250 cterm=NONE guibg=#080808 guifg=#bcbcbc gui=NONE
