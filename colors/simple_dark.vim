...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    hi Normal ctermbg=236 ctermfg=252 cterm=NONE guibg=#222222 guifg=#d0d0d0 gui=NONE
    hi NonText ctermbg=236 ctermfg=252 cterm=NONE guibg=#222222 guifg=#d0d0d0 gui=NONE
    ...
    hi Type ctermbg=NONE ctermfg=247 cterm=NONE guibg=NONE guifg=#9e9e9e gui=NONE
    ...
    hi VertSplit ctermbg=236 ctermfg=250 cterm=NONE guibg=#222222 guifg=#bcbcbc gui=NONE
    ...
    hi helpLeadBlank ctermbg=236 ctermfg=250 cterm=NONE guibg=#222222 guifg=#bcbcbc gui=NONE
    hi helpNormal ctermbg=236 ctermfg=250 cterm=NONE guibg=#222222 guifg=#bcbcbc gui=NONE
